...
public class Maps02 {
	...
	for (String each : map1.values()) {  // map den collection olusturduk
		//{{Ali, Can, java}, {Veli, Yan, java}, {Ali, Yan, C#}}
		// birinci ekeman    // ikinci eleman  // ucuncu eleman
		String arr []= each.split(", ");  //[Ali, Can, java]  [Veli, Yan, java]  [Ali, Yan, C#]
		//									  0    1    2		0	  1     2     0    1    2
